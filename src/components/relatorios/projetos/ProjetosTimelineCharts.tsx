...
export function ProjetosTimelineCharts({ projetos }: Props) {
        ...
        <ResponsiveContainer width="100%" height="100%">
          ...
          >
            ...
            <Legend
              ...
              iconType="line"
              formatter={(value) => {
                if (value === "valorPorFoto") return "Valor por Foto (R$)";
                if (value === "horasPorFoto") return "Horas por Foto";
                return value;
              }}
            />
            <Line
