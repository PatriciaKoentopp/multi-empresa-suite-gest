...
export const useDashboardCards = (pageId: string = 'dashboard') => {
  ...
  const defaultCards = {
    ...
    'painel-vendas': [
      ...
      { card_id: 'vendas-por-servico-ano', name: 'Vendas por Serviço por Ano', order_position: 7, is_visible: true },
    ],
    'painel-crm': [
    ...
    'relatorios': [
      ...
      { card_id: 'financeiro', name: 'Relatório Financeiro', order_position: 7, is_visible: true },
      { card_id: 'geral', name: 'Relatório Geral', order_position: 8, is_visible: true },
    ]
  };
