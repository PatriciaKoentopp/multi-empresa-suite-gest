...
export const usePdfFluxoCaixa = () => {
  const gerarPdfFluxoCaixa = (
    ...
    try {
      ...
      const getFavorecidoNome = (linha: any) => {
      ...
      const getTituloParcela = (linha: any) => {
      ...
      movimentacoesOrdenadas.forEach(linha => {
        saldoAcumulado += Number(linha.valor || 0);
      ...
      autoTable(doc, {
        ...
        columnStyles: {
          ...
          1: { cellWidth: 25, halign: 'center' }, // Título/Parcela
          2: { cellWidth: 40, halign: 'left' },   // Favorecido
          3: { cellWidth: 60, halign: 'left' },   // Descrição
          4: { cellWidth: 25, halign: 'center' }, // Situação
