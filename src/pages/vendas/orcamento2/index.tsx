...
import { ItensFlexiveisForm } from "@/components/vendas/orcamento2/ItensFlexiveisForm";
import { parseDateString } from '@/lib/utils';

export default function Orcamento2Page() {
    ...
    <div className="max-w-3xl mx-auto flex flex-col gap-6">
      <div className="flex justify-between items-center">
        <h2 className="text-2xl font-semibold">
          {orcamentoId 
            ? isVisualizacao 
              ? "Visualizar Orçamento 2.0" 
              : "Editar Orçamento 2.0" 
            : "Novo Orçamento 2.0"
          }
          <span className="ml-2 text-sm text-blue-500 font-normal">(Versão Flexível)</span>
        </h2>
      </div>
        ...
        <CardContent>
          <form className="flex flex-col gap-4" onSubmit={handleFormSubmit}>
            ...
            <ItensFlexiveisForm
              ...
              onRemoveItem={handleRemoveServico}
              disabled={isVisualizacao}
            />
